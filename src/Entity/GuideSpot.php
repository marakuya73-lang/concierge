...
#[ORM\Entity(repositoryClass: GuideSpotRepository::class)]
class GuideSpot
{
    ...
    #[ORM\ManyToOne(inversedBy: 'guideSpots')]
    #[ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')]
    private ?Property $property = null;

    #[ORM\Column(length: 20)]
    private string $type = self::TYPE_SPOT;
    ...
    {
        return $this->imageFilename ? '/uploads/property/'.$this->imageFilename : null;
    }
}
